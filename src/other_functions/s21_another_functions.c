...
// отрицательной бесконечности. dec структура которую хотим изменить result
// стркутра для записи нового числа Возвращает 1 или 0, в зависимости от
...
// Возвращает 1 или 0, в зависимости от успешности выполнения
...
// dec структура которую хотим изменить
// result структура для записи нового числа
// Возвращает 1 или 0, в зависимости от успешности выполнения
